function [sys,x0,str,ts,simStateCompliance] = attitude_controller_2usin(t,x,u,flag,dt,Rd,wd,ad,J,K,dtheta)
...
tmp1=Rr*hat_ew*hat(w)-hat(iwd)*Rr*hat_ew-hat(iad)*Rr;
tmp=tmp1-tmp1';
